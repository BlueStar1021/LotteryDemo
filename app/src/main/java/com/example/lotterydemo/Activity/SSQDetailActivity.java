...
public class SSQDetailActivity extends NetworkWatcherActivity implements JsonActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ssqdetail);

        btnRet = (Button)findViewById(R.id.activity_ssqdetail_return);

        no = (TextView)findViewById(R.id.activity_ssqdetail_lottery_no);
        date = (TextView)findViewById(R.id.activity_ssqdetail_lottery_date);
        exdate = (TextView)findViewById(R.id.activity_ssqdetail_lottery_exdate);
        saleAmount = (TextView)findViewById(R.id.activity_ssqdetail_lottery_sale_amount);
        poolAmount = (TextView)findViewById(R.id.activity_ssqdetail_lottery_pool_amount);

        red_1 = (TextView)findViewById(R.id.activity_ssqdetail_red_1);
        red_2 = (TextView)findViewById(R.id.activity_ssqdetail_red_2);
        red_3 = (TextView)findViewById(R.id.activity_ssqdetail_red_3);
        red_4 = (TextView)findViewById(R.id.activity_ssqdetail_red_4);
        red_5 = (TextView)findViewById(R.id.activity_ssqdetail_red_5);
        red_6 = (TextView)findViewById(R.id.activity_ssqdetail_red_6);
        blue = (TextView)findViewById(R.id.activity_ssqdetail_blue);
        ...
        btnRet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SSQDetailActivity.super.finish();
            }
        });

        //检查网络
        if(isNetworkAvailable(SSQDetailActivity.this) == false){
            //网络不可用
